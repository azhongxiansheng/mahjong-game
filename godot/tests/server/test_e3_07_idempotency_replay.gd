...
func test_snapshot_provider_roundtrip_standard_and_reward_compat() -> void:
	...
	assert_eq(keys_tt.size(), 8)
	assert_eq(str(keys_tt[0]), "core_table")
	assert_eq(str(keys_tt[1]), "item_inventory")
	assert_eq(str(keys_tt[2]), "matching_meta")
	assert_eq(str(keys_tt[3]), "reward_window")
	assert_eq(str(keys_tt[4]), "viewer_next_draw")
	assert_eq(str(keys_tt[5]), "viewer_seat_draw_forecast")
	assert_eq(str(keys_tt[6]), "viewer_tenpai_waits")
	assert_eq(str(keys_tt[7]), "viewer_wall_top")
	...
	assert_eq(tt_keys.size(), 4)
	assert_eq(str(tt_keys[0]), "core_table")
	assert_eq(str(tt_keys[1]), "item_inventory")
	assert_eq(str(tt_keys[2]), "matching_meta")
	assert_eq(str(tt_keys[3]), "reward_window")
